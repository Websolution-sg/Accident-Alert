...
print("🔍 CONFIRMING BOT TOKEN ACCESS TO YOUR CHANNEL")
print("=" * 60)
...
if access_confirmed:
    ...
    try:
        test_message = "🔧 Bot access confirmation test"
...
if access_confirmed and send_confirmed:
    print("✅ Bot token IS VALID for your channel")
    ...
    print("❌ Bot token CANNOT ACCESS your channel")
